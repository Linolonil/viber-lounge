...
import { LayoutDashboard, ShoppingCart, Package, Plus, History, LogOut, User } from "lucide-react";
...
export default function Navbar() {
  ...
  return (
    <nav className="h-full w-64 bg-zinc-800 border-r border-zinc-700 p-4 flex flex-col">
      <div className="mb-8">
      ...
      <button
        ...
        className="flex items-center gap-3 px-4 py-2 rounded-md text-gray-300 hover:bg-zinc-700 transition-colors mt-auto"
      >
